...
- 辅助指示视图的作用是显示一个表示动作的图标，可以通过设置UITableViewCell的accessoryType来显示，默认是UITableViewCellAccessoryNone(不显示辅助指示视图)，其他值如下:
	+ UITableViewCellAccessoryDisclosureIndicator ![](/Users/John/Desktop/今日笔记图片/辅助指示图1.png)
	+ UITableViewCellAccessoryDetailButton ![](/Users/John/Desktop/今日笔记图片/辅助指示图2.png)
	+ UITableViewCellAccessoryDetailDisclosureButton ![](/Users/John/Desktop/今日笔记图片/辅助指示图3.png)
	+ UITableViewCellAccessoryCheckmark ![](/Users/John/Desktop/今日笔记图片/辅助指示图4.png)
...
- UITableViewCell还有一个UITableViewCellStyle属性，用于决定使用contentView的哪些子视图，以及这些子视图在contentView中的位置
	![](/Users/John/Desktop/今日笔记图片/UITableViewCellStyle属性.png)

##### UITableViewCell结构


![](/Users/John/Desktop/今日笔记图片/UITableViewCell结构.png)
- 好像这个图表达的不是很清楚，解释一下
...
- 如何使用
![](/Users/John/Desktop/今日笔记图片/UITableViewController.gif)
...
##### 还记得刚刚上面说的tableView里面的cell是懒加载嘛，但是懒加载之后，并不会释放掉
